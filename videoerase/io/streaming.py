"""Streaming runtime IO and lifecycle helpers for LTX095 videoerase."""
...
from videoerase.contracts import ObjectRuntimeState
from videoerase.contracts import _is_windowed_runtime_mode
