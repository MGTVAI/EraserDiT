...
class LTXVideoToVideoPipeline(DiffusionPipeline, FromSingleFileMixin, LTXVideoLoraLoaderMixin):
    ...
    def prepare_latents(
        ...
        #     noise, self.transformer_spatial_patch_size, self.transformer_temporal_patch_size
        # )
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                video_latents_input = torch.cat([video_latents] * 2) if self.do_classifier_free_guidance else video_latents
                mask_values_input = torch.cat([mask_values] * 2) if self.do_classifier_free_guidance else mask_values
                ...
                if self.do_classifier_free_guidance:
                    noise_pred_uncond = self.transformer(
                        ...
                        return_dict=False,
                        cond_latents=video_latents_input[0:1, ...],
                        mask_values=mask_values_input[0:1, ...],
                    )[0]
                    ...
                    noise_pred_text = self.transformer(
                        ...
                        attention_kwargs=attention_kwargs,
                        return_dict=False,
                        cond_latents=video_latents_input[1:, ...],
                        mask_values=mask_values_input[1:, ...],
                    )[0]
                    ...
                    noise_pred = self.transformer(
                        ...
                        attention_kwargs=attention_kwargs,
                        return_dict=False,
                        cond_latents=video_latents_input,
                        mask_values=mask_values_input,
                    )[0]
